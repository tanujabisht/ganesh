   ...
   <div class="col-xs-12 ">
      ...
      <div class="box">
         <div class="box-header">
            <h3 class="box-title">Admin Summary</h3>
         </div>  
         <div class="box-body table-responsive no-padding">
           <table class="table table-bordered">
                ...
                <?php foreach ($clinics as $user): ?>
                    ...
                    <td class="hidenwforprint"><?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action'=>'adminadd', $user->id), array('escape' => false)); ?></td>
                    <td class="hidenwforprint">
                        <?= $this->Form->postLink('<span class="glyphicon glyphicon-remove-circle"></span>',
                            array('action' => 'admindelete', $user->id),
